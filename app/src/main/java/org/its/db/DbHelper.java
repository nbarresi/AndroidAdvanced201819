...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "CREATE TABLE profilo (id Integer primary key AUTOINCREMENT, nome varchar(50), volume integer DEFAULT 50, luminosita integer DEFAULT 50, auto_luminosita integer DEFAULT 0,  metodo integer NOT NULL, bluetooth integer DEFAULT 0, wifi integer DEFAULT 0, rilevazione varchar(255) NOT NULL);";
